...
public class booking2 extends JFrame {
    ...
    private void processBooking() {
        ...
        try {
            ...
            if (meal.equals("Room Only")) {
                ...
                String sql = "SELECT Price FROM glrooms WHERE ID IN (1, 2, 3)";
    ...
    private void Confirm() {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            Checkout2 Checkout2Frame = new Checkout2();
            Checkout2Frame.setVisible(true);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new booking2().setVisible(true));
