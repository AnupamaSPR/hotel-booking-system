...
public class Galle extends JFrame {
    ...
    public Galle() {
        ...
        backgroundImage = new ImageIcon(getClass().getResource("/images/Gb4.jpg")).getImage();
        ...
        titleLabel.setForeground(new Color(13, 26, 58));
        ...
        String[] imagePaths = {"/images/ga1.jpg", "/images/ga2.jpg", "/images/ga3.jpg", "/images/ga4.jpg"};
        ...
        buttonSubtitle.setForeground(Color.WHITE);
    ...
    private void openLogin() {
        ...
        this.dispose();
        login2Frame.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
    ...
    private void openSignup() {
        ...
        this.dispose();
        signup2Frame.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                hideBlurEffect();
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Galle().setVisible(true));
    }
}
