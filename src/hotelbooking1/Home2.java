...
public class Home2 extends JFrame {
    ...
    public Home2() {
        ...
        backgroundImage = new ImageIcon(getClass().getResource("/images/GalleB.jpg")).getImage();

        setTitle("Sandy Beach Hotel Galle");
        ...
        table2.setBackground(new Color(178, 197, 234));
        ...
        // Title Label
        titleLabel = new JLabel("Sandy Beach Hotel in Galle", SwingConstants.CENTER);
        ...
        String[] imagePaths = {"/images/Gb.jpg", "/images/Gb1.jpg", "/images/Gb5.jpg", "/images/GalleBa.jpg"};
    ...
    private void fetchRoomData() {
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotelBooking1", "root", "");
             ...
             ResultSet rs = stmt.executeQuery("select*from glrooms")) {
    ...
    private void Reservation() {
        ...
        booking2 booking2Frame = new booking2();
        booking2Frame.setVisible(true);
        booking2Frame.setLocationRelativeTo(null);
        booking2Frame.addWindowListener(new java.awt.event.WindowAdapter() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Home2().setVisible(true));
    }
}